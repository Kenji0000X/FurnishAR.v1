...
async function listApplications() {
  return supabaseRequest('/rest/v1/store_applications?select=id,store_name,contact_email,contact_phone,message,status,created_at&status=eq.pending&order=created_at.asc');
}

...
export const CATALOG = Object.freeze({
  ...
  'auth.google-cancelled': {
    type: 'info', title: 'Google sign-in cancelled',
    message: 'You closed Google before finishing. Nothing was changed — try again whenever you are ready.'
  },
  'auth.google-unavailable': {
    type: 'error', priority: 'high', title: 'Google sign-in unavailable',
    message: "Google sign-in isn't available right now. Use your email and password, or try again later."
  },
  'auth.google-expired': {
    type: 'warning', title: 'Sign-in timed out',
    message: 'That sign-in took too long and expired. Please continue with Google again.'
  },
  'auth.google-used': {
    type: 'info', title: 'Sign-in link already used',
    message: 'That Google sign-in was already completed. If you are not signed in, continue with Google again.'
  },
  'auth.google-failed': {
    type: 'error', title: 'Google sign-in failed',
    message: "We couldn't finish signing you in with Google. Please try again."
  },
  'auth.network': {
    type: 'error', title: 'Connection problem',

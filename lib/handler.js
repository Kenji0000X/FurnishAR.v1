...
const PUBLIC_FILES = new Set(['index.html', 'styles.css', 'client.js', 'config.js', 'supabase.js']);
...
const MIME = { '.html': 'text/html; charset=utf-8', '.js': 'text/javascript; charset=utf-8', '.css': 'text/css; charset=utf-8', '.json': 'application/json; charset=utf-8', '.svg': 'image/svg+xml', '.glb': 'model/gltf-binary', '.usdz': 'model/vnd.usdz+zip' };

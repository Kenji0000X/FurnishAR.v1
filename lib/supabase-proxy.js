...
const ALLOWED_TABLES = new Set([
  ...
  // 0015. Payouts FurnishAR made to a store for Maya payments it collected.
...
const ALLOWED_FUNCTIONS = new Set([
  ...
  'platform_fee_rate',
  // 0015. Both check is_platform_admin() themselves: enabling Maya for a
  // store (there is no self-service Maya onboarding) and recording a payout.
  'admin_set_maya_account',
